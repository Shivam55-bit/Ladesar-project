...
export const BrandLogo: React.FC<BrandLogoProps> = ({
  ...
  const sizeClasses = {
    sm: { emblem: 'w-6 h-6', title: 'text-lg tracking-[0.18em]', sub: 'text-[9px]', tagline: 'text-[8px]' },
    md: { emblem: 'w-9 h-9', title: 'text-2xl tracking-[0.22em]', sub: 'text-[10px]', tagline: 'text-[9px]' },
    lg: { emblem: 'w-14 h-14', title: 'text-4xl tracking-[0.24em]', sub: 'text-xs', tagline: 'text-[11px]' },
    xl: { emblem: 'w-20 h-20', title: 'text-5xl tracking-[0.28em]', sub: 'text-sm', tagline: 'text-xs' },
  }[size];
    ...
    >
      ...
      <div className={`relative flex items-center justify-center ${sizeClasses.emblem} mb-1.5`}>
        <svg viewBox="0 0 120 120" className="w-full h-full drop-shadow-md transition-transform duration-300 group-hover:scale-105" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Center Lotus Core Flame / Teardrop */}
          <path
